...
void QuickLookDialog::showFile(const QString &filePath) {
    ...
    if (f.endsWith(".png") || f.endsWith(".jpg") || f.endsWith(".jpeg") || f.endsWith(".bmp") || f.endsWith(".webp")) {
    ...
    } else if (f.endsWith(".txt") || f.endsWith(".cpp") || f.endsWith(".h") || f.endsWith(".md") || f.endsWith(".json") || f.endsWith(".log")) {
        QFile file(filePath);
